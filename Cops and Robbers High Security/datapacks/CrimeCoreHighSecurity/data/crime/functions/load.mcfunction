...
# crime_marker_typebutton_# - selection button
# crime_marker_setting_(setting) - a lever or something
# crime_marker_teleportal - primary teleportal
# crime_marker_teleportal_(location) - locations to teleportal to
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #